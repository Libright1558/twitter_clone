...
const fetchUserRetweet = 'SELECT p.postby, p.content, p.ts, p.pinned, p.like_people, p.retweet_people, p.post_id, u.retweet_ts FROM post_records AS p, user_retweets AS u WHERE u.username = $1 AND p.post_id = u.post_id ORDER BY u.retweet_ts DESC';
